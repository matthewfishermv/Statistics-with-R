...
| Regression fit (R²) | The coefficient of variation or coefficient of determination (R²) is a measure of the variability explained by a linear model as a proportion of the total variability. | ![Formula for coefficient of variation](/Course-Content/Images/Equations/coefficient-of-determination.png) | `summary(lm())` | `summary(model(y ~ x))` |
